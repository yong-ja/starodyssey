...
namespace AvengersUtd.Odyssey.Resources
{
    public static class TextureManager
    {
        ...
        public static void Add(string key, Texture texture)
        {
            SurfaceDescription desc = texture.GetLevelDescription(0);

            textureCache.Add(key, new CacheNode<Texture>(24 * desc.Width * desc.Height, texture)); 
        }
        ...
        public static Texture LoadTexture(string filename)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    textureCache.Add(filename, new CacheNode<Texture>(24*desc.Width*desc.Height, texture));
                    return texture;
                }
