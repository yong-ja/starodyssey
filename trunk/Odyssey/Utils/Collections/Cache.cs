...
namespace AvengersUtd.Odyssey.Collections
{
    ...
    public struct CacheNode<Resource> : ICacheable
    {
        int bytesUsed;
        Resource resource;

        public CacheNode(int bytesUsed, Resource genericObject)
        {
        ...
        where Value : ICacheable
    {
        ...
        /// </summary>
        int maxBytes = 256*1024*1024; // 256 MB
