...
namespace AvengersUtd.Odyssey.UserInterface.Style
{
    ...
    public class CustomColorDialog : IDisposable
    {
        ...
        private System.Windows.Forms.TextBox _textAlpha;
        // the panel to contain the slider and text box
        private System.Windows.Forms.Panel _panelAlpha;
        // final color value
        private System.Drawing.Color _color;
        private UInt32 messagecode = 0;
        ...
        {
            messagecode = NativeMethods.RegisterWindowMessage(new StringBuilder("commdlg_ColorOK"));
            ...
            _panelAlpha = new System.Windows.Forms.Panel();
            _sliderAlpha = new AlphaSlider();
            _textAlpha = new System.Windows.Forms.TextBox();

            _panelAlpha.Controls.Add(_sliderAlpha);
            _panelAlpha.Controls.Add(_textAlpha);

            _panelAlpha.BorderStyle = System.Windows.Forms.BorderStyle.None;
        ...
        public IntPtr MyHookProc(IntPtr hWnd, UInt16 msg, Int32 wParam, Int32 lParam)
        {
            ...
            if (msg == messagecode /*==COLOROKSTRING*/)
            {
                ...
                int R = (int)(cc.rgbResult) & 0xFF;
                int G = (int)(cc.rgbResult >> 8) & 0xFF;
                int B = (int)(cc.rgbResult >> 16) & 0xFF; 
