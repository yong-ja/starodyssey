...
namespace AvengersUtd.MultiversalRuleSystem.Space.CelestialObjects
{
    ...
    public class StellarFeatures
    {
        ...
        {
            get { return new OrbitalParameters(semiMajorAxis, semiMinorAxis, eccentricity, 0, orbitalPeriod, 0); }
        }
        ...
        /// <summary>
        /// Returns the orbital period, in Years.
        /// </summary>
        ...
        {
            get { return radius*PhysicalConstants.SolarRadiusInKilometers/PhysicalConstants.KmPerAU; }
        }
        ...
        public double SnowlineRadius
        {
            get { return 4.85*Math.Sqrt(luminosity); }
        }
