...
namespace AvengersUtd.MultiversalRuleSystem.Space.GalaxyGeneration
{
    public class GalaxyGenerator
    {
        ...
        public SortedDictionary<string, SolarSystem> GenerateStars()
        {
            ...
            double blueDwarf = starChances[StarType.BlueDwarf];
            double yellowDwarf = starChances[StarType.YellowDwarf];
            double orangeDwarf = starChances[StarType.OrangeDwarf];
            double redDwarf = starChances[StarType.RedDwarf];
        ...
        public SolarSystem CreateSingleStarSystem(string systemName, double mass)
        {
            ...
            while (node != null)
            {
                planetGenerator.GeneratePlanet(node.Value);
                node = node.Next;
            }
