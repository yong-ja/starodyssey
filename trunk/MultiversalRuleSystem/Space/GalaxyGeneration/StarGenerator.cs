...
namespace AvengersUtd.MultiversalRuleSystem.Space.GalaxyGeneration
{
    public class StarGenerator
    {
            ...
            out EvolutionResult evolutionResult, out StellarFeatures mainSequenceFeatures)
        {
            ...
            magnitude = rnd.About(MathHelper.Interpolate(bolumetricMagnitudeTable, iValues), 0.005);
            temperature = rnd.About(MathHelper.Interpolate(temperatureTable, iValues),0.01);
            ...
            mainSequenceFeatures = new StellarFeatures(starName,
                GetStarType(spectralType),
                magnitude,
                mass,
                luminosity,
                temperature,
                ...
                density,
                age,
                GenerateSpectralClass(spectralType, subType, luminosityClass));

            return Evolve(out evolutionResult);
        }

        static StarType GetStarType(int type)
        {
            StarType starType = StarType.Unknown;
        ...
        string GenerateSpectralClass(int classIndex, int subType, string luminosityClass)
        {
            return string.Format("{0}{1} {2}", typeCharArray[classIndex], subType, luminosityClass);
        }
        ...
        Star Evolve(out EvolutionResult evolutionResult)
        {
            ...
            StellarFeatures evolvedFeatures = new StellarFeatures(starName,
                GetStarType(spectralType),
                magnitude,
                mass,
                luminosity,
