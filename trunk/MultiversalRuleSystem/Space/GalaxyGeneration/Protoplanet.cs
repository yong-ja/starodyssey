...
using AvengersUtd.MultiversalRuleSystem.Space.CelestialObjects;
    ...
    public class Protoplanet
    {
        ...
        public Protoplanet(CelestialFeatures celestialFeatures)
        {
            a = celestialFeatures.SemiMajorAxis;
        }
        ...
        {
            dustDensity =  10000*PhysicalConstants.DustDensityCoefficient * Math.Sqrt(planetMass /PhysicalConstants.SolarMassInEarthMasses)
                          * Math.Exp(-PhysicalConstants.Alpha * Math.Pow(a, (1.0 / PhysicalConstants.N)));
        }
