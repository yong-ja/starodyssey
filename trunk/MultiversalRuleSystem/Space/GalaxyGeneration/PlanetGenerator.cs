...
namespace AvengersUtd.MultiversalRuleSystem.Space.GalaxyGeneration
{
    ...
    public partial class PlanetGenerator
    {
                                                      ...
                                                      bool isGasGiant)
        {
            ...
            if (isGasGiant && orbitalRadius <= ecosphereRadius)
                orbitalRadius = Dice.Rnd.AboutHigh(4.85*ecosphereRadius, 5.0);
        ...
        public CelestialFeatures GenerateEvolvedPlanet(CelestialFeatures celestialFeatures)
        {
            isGasGiant = celestialFeatures.IsGasGiant;
            mass = celestialFeatures.Mass;
            dustMass = celestialFeatures.DustMass;
            gasMass = celestialFeatures.GasMass;
            orbitalRadius = celestialFeatures.SemiMajorAxis;
            eccentricity = celestialFeatures.Eccentricity;
        ...
        CelestialFeatures ComputeValues(double ecosphereRadius)
        {
            ...
            dayLength = ComputeDayLength(mass, radius, eccentricity, density, orbitalRadius, orbitalPeriod,
                                         stellarMass, stellarFeatures.Age, isGasGiant, out resonantPeriod);
