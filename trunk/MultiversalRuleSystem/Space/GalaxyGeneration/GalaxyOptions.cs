...
namespace AvengersUtd.MultiversalRuleSystem.Space.GalaxyGeneration
{
    public class StarChances
    {
        ...
        {
            get { return this[StarType.BlueDwarf]; }
            set { this[StarType.BlueDwarf] = value; }
        }

        public double OrangeDwarf
        {
            get { return this[StarType.OrangeDwarf]; }
            set { this[StarType.OrangeDwarf] = value; }
        }

        public double YellowDwarf
        {
            get { return this[StarType.YellowDwarf]; }
            set { this[StarType.YellowDwarf] = value; }
        }

        public double RedDwarf
        {
            get { return this[StarType.RedDwarf]; }
            set { this[StarType.RedDwarf] = value; }
        }
        ...
        {
            this[StarType.BlueDwarf] = blueDwarf;
            this[StarType.YellowDwarf] = yellowDwarf;
            this[StarType.OrangeDwarf] = orangeDwarf;
            this[StarType.RedDwarf] = redDwarf;
        }

        public double this[StarType type]
        {
    ...
    public class GalaxyOptions
    {
        ...
        public EmptyOrbitChances[] EmptyOrbitChances
        {
            ...
            set
            {
                ...
                for (int i = 0; i < emptyOrbitChances.Length; i++)
                    emptyOrbitChances[i].Type = (StarType) (i + 1);
            }
        }
                             ...
                             GasGiantChances gasGiantChance)
        {
            ...
            for (int i = 0; i < this.emptyOrbitChances.Length; i++)
                this.emptyOrbitChances[i].Type = (StarType) (i + 1);
        ...
        public GalaxyOptions(string id,
                             ...
                             GasGiantChances gasGiantChance)
            : this(
                id, 0, 0, starCount, age, shape, size, planetDensity, starChances, emptyOrbitChances, zoneChances,
