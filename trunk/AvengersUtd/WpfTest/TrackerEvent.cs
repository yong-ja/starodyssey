...
namespace WpfTest
{
    public class TrackerEvent : LogEvent
    {
        ...
        public static TrackerEvent BoxSessionStart = new TrackerEvent("TrackerDesc", "START, BoxSession {0}, Width:{1:f2} Depth:{2:f2} Height: {3:f2} Axis: {4} ArrowCn: {5}");
        ...
        public static TrackerEvent PointSessionStart= new TrackerEvent("TrackerDesc", "Start,P ointSession {0}, Size:{1:f2}, Distance:{2:f2}");
