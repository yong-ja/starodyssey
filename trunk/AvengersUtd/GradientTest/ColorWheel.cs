...
using AvengersUtd.GradientTest.Properties;
    ...
    public class ColorWheel : IDisposable
    {
             ...
             Rectangle selectedColorRectangle)
        {
            ...
            using (GraphicsPath path = new GraphicsPath())
            {
                ...
                path.AddRectangle(new Rectangle(brightnessRectangle.Left,
                                                brightnessRectangle.Top - 10,
                                                brightnessRectangle.Width + 10,
                                                brightnessRectangle.Height + 20));
        ...
        private void DrawLinearGradient(Color TopColor)
        {
            ...
            using (LinearGradientBrush lgb = new LinearGradientBrush(brightnessRectangle,
                                                  TopColor,
                                                  Color.Black,
        ...
        private void CreateGradient()
        {
            ...
            using (PathGradientBrush pgb = new PathGradientBrush(GetPoints(radius, new Point(radius, radius))))
            {
                ...
                colorImage = new Bitmap(colorRectangle.Width,
        ...
        private Color[] GetColors()
        {
            ...
            for (int i = 0; i <= COLOR_COUNT - 1; i++)
                Colors[i] = ColorHandler.HSVtoColor(255,
                                                    (int) ((double) (i*255)/COLOR_COUNT),
                                                    255,
                                                    255);
            return Colors;
        }
