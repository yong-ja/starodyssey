...
namespace AvengersUtd.MultiversalRuleSystem.Space.GalaxyGeneration
{
    public class StarGenerator
    {
        ...
        readonly double[] minimumLuminosityTable;
        readonly double[] maximumLuminosityTable;
        ...
        public StarGenerator(GalaxyOptions galaxyOptions)
        {
            ...
            minimumLuminosityTable = new double[tableLength];
            maximumLuminosityTable = new double[tableLength];
        ...
        void GenerateStarTables()
        {
            ...
            // Ax modifiers
            minimumLuminosityTable[25] = 16.0;
            minimumLuminosityTable[26] = 13.0;
            minimumLuminosityTable[27] = 11.0;
            minimumLuminosityTable[29] = 8.6;

            maximumLuminosityTable[25] = 20.0;
            maximumLuminosityTable[26] = 16.0;
            maximumLuminosityTable[27] = 13.0;
            maximumLuminosityTable[29] = 10.0;

            // Fx modifiers
            minimumLuminosityTable[30] = 6.7;
            minimumLuminosityTable[32] = 5.1;
            minimumLuminosityTable[33] = 4.3;
            minimumLuminosityTable[34] = 3.7;
            minimumLuminosityTable[35] = 3.1;
            minimumLuminosityTable[36] = 2.5;
            minimumLuminosityTable[37] = 2.1;
            minimumLuminosityTable[38] = 1.7;
            minimumLuminosityTable[39] = 1.4;

            maximumLuminosityTable[30] = 8.2;

            maximumLuminosityTable[32] = 6.5;
            maximumLuminosityTable[33] = 5.7;
            maximumLuminosityTable[34] = 5.1;
            maximumLuminosityTable[35] = 4.5;
            maximumLuminosityTable[36] = 3.9;
            maximumLuminosityTable[37] = 3.5;
            maximumLuminosityTable[38] = 3.0;
            maximumLuminosityTable[39] = 2.6;

            // Gx modifiers
            minimumLuminosityTable[40] = 1.1;
            minimumLuminosityTable[41] = 0.87;
            minimumLuminosityTable[42] = 0.68;
            minimumLuminosityTable[44] = 0.56;
            minimumLuminosityTable[46] = 0.45;
            minimumLuminosityTable[48] = 0.36;

            maximumLuminosityTable[40] = 2.2;
            maximumLuminosityTable[41] = 1.9;
            maximumLuminosityTable[42] = 1.6;
            maximumLuminosityTable[44] = 1.3;
            maximumLuminosityTable[46] = 1.0;
            maximumLuminosityTable[48] = 0.84;

            // Kx modifiers
            minimumLuminosityTable[50] = 0.28;
            minimumLuminosityTable[52] = 0.23;
            minimumLuminosityTable[54] = 0.19;
            minimumLuminosityTable[55] = 0.15;
            minimumLuminosityTable[56] = 0.13;
            minimumLuminosityTable[58] = 0.11;

            maximumLuminosityTable[50] = 0.65;
            maximumLuminosityTable[52] = 0.48;
            maximumLuminosityTable[54] = 0.35;
            maximumLuminosityTable[55] = 0.25;
            maximumLuminosityTable[56] = 0.20;
            maximumLuminosityTable[58] = 0.15;

            // Mx modifiers
            minimumLuminosityTable[60] = 0.09;
            minimumLuminosityTable[61] = 0.07;
            minimumLuminosityTable[62] = 0.054;
            minimumLuminosityTable[63] = 0.037;
            minimumLuminosityTable[64] = 0.024;
            minimumLuminosityTable[65] = 0.015;
            minimumLuminosityTable[66] = 0.0079;
            minimumLuminosityTable[67] = 0.0036;
            minimumLuminosityTable[68] = 0.0012;

            maximumLuminosityTable[60] = 0.09;
            maximumLuminosityTable[61] = 0.07;
            maximumLuminosityTable[62] = 0.054;
            maximumLuminosityTable[63] = 0.037;
            maximumLuminosityTable[64] = 0.024;
            maximumLuminosityTable[65] = 0.015;
            maximumLuminosityTable[66] = 0.0079;
            maximumLuminosityTable[67] = 0.0036;
            maximumLuminosityTable[68] = 0.0012;
            #endregion
        ...
        public Star[] GenerateMultipleStarSystem(string starSystemName, double[] starMasses, 
            out double[] meanSeparationDistanceArray)
        {
            int length = starMasses.Length;
            Star[] starSystem = new Star[length];
            List<double> meanSeparationDistances=  new List<double>();
            ...
            for (int i=0; i<starMasses.Length; i=i+2)
            {
                ...
                if ((starMasses.Length - i) >= 2)
                {
                    ...
                    meanSeparationDistances.Add(separation);

                    // Inits the star mass value:
                    starMassesSum += starMasses[i];

                    // generate random semimajor axis and eccentricity for the first star
                    double firstStarSemiMajorAxis = semiMajorAxis = ComputeSemiMajorAxis(starMassesSum, starMasses[i + 1], separation);
                    ...
                    semiMajorAxis = separation - firstStarSemiMajorAxis;
                    eccentricity = GenerateEccentricity();
                    orbitalPeriod = ComputeOrbitalPeriod(starMassesSum, starMasses[i + 1], semiMajorAxis);
                ...
                else
                {
                    ...
                    double separation = GenerateSeparation();
                    meanSeparationDistances.Add(separation);
                    semiMajorAxis = separation - ComputeSemiMajorAxis(starMassesSum, starMasses[i], separation);
                    eccentricity = GenerateEccentricity();
            ...
            meanSeparationDistanceArray = meanSeparationDistances.ToArray();
            return starSystem;
        ...
        {
            mass = starMass;
            iValues = MathHelper.FindInterpolationInterval(mass, massTable);
            ...
            StellarFeatures mainSequenceFeatures = new StellarFeatures(
            ...
            StellarFeatures evolvedFeatures = Evolve(out evolutionResult);

            return new Star(starName, evolvedFeatures, mainSequenceFeatures, evolutionResult);
        }
        ...
        static double GetRandomAge(GalaxyAge galaxyAge)
        {
            ...
            return rnd.About(age,age * 0.05);
        }

        StellarFeatures Evolve(out EvolutionResult evolutionResult)
        {
            double subGiantLifespan = rnd.About(lifespan * 0.15, 0.05);
            double giantLifespan = rnd.About(lifespan * 0.1, 0.05);
            ...
            else if (age < lifespan + subGiantLifespan + giantLifespan)
            {
            ...
            return new StellarFeatures(magnitude, mass, luminosity, temperature, radius, semiMajorAxis, eccentricity, orbitalPeriod, density, age,
                new SpectralClass((SpectralType)spectralType, subType, luminosityClass));
        ...
        void EvolveOnMainSequence()
        {
            if (spectralType < 6)
            {
                double minimumLuminosity = MathHelper.CubicInterpolation(minimumLuminosityTable, iValues);
                double maximumLuminosity = MathHelper.CubicInterpolation(maximumLuminosityTable, iValues);
                if (minimumLuminosity == 0)
                {
                    minimumLuminosity = luminosity*0.75;
                    maximumLuminosity = luminosity*1.25;
                }

                luminosity = minimumLuminosity + (age/lifespan*(maximumLuminosity - minimumLuminosity));

                luminosity = Dice.RollGaussian(luminosity, luminosity*0.05);
        ...
        void EvolveAsSubGiant(double subGiantLifespan)
        {
            ...
            luminosity = MathHelper.CubicInterpolation(maximumLuminosityTable, iValues);
            luminosity = Dice.RollGaussian(luminosity, luminosity * 0.05);
            magnitude = ComputeAbsoluteBolumetricMagnitude(luminosity);
            ...
            iValues = MathHelper.FindInterpolationInterval(temperature, temperatureTable);
            spectralType = iValues[1] / 10;
            subType = iValues[1] % 10;
        ...
        void EvolveAsGiant()
        {
            luminosity = Dice.Roll(2000,5000) * MathHelper.CubicInterpolation(maximumLuminosityTable, iValues);
            luminosity = Dice.RollGaussian(luminosity, luminosity*0.1);
            magnitude = ComputeAbsoluteBolumetricMagnitude(luminosity);

            temperature = Dice.Roll(3000, temperature);
            radius = ComputeRadius(luminosity, temperature);
